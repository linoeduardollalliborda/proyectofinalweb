			...
			echo "
				<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<div class='panel-heading'>S/.$pro_price.00  alquiler
	...
	if(isset($_POST["addToProduct"])){
		...
		if($count > 0){
			...
			echo "
					<div class='alert alert-success'>
						<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
						<b>Lo siento ..! Ir y Registrarse Primero, entonces puedes agregar un producto a tu carrito y alquilar productos</b>
					</div>
				";
		}
		...
		while($row=mysqli_fetch_array($run_query)){
			...
			if(isset($_POST["get_cart_product"])){
				...
				<div class='row'>
					...
					<div class='col-md-3 col-xs-3'>S/.$pro_price.00</div>
				</div>
			";
			$no = $no + 1;
			}else{
