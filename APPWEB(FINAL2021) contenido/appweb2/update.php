<?php 
    ...
    {   
        echo <<<_END
             ...
             <h2 class="main2"> 
             <ul>
             <li ><a href="profile.php"> <img style="margin-top:10px;margin-left:40px;margin-right:20px;" class="img1" src="product_images/logo.png" width="40px" height="40px"> <a href="profile.php" class="navbar-brand">Elegancia y pasión  </a>  </li>   
             </ul></div>
