	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">	
			<div class="navbar-header">
				<a href="#" class="navbar-brand"> Almacenar Elegancia y pasión</a>
			</div>
...
completado con éxito y su ID de transacción es<b></b><br/>
						puedes continuar tus alquileres de trajes<br/></p>
						<a href="index.php" class="btn btn-success btn-lg">Seguir adquiriendo trajes</a>
					</div>
